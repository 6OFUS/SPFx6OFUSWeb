  ...
  return (
    <div className="bg-[url(/oriBg.png)] w-screen h-auto bg-contain bg-top flex flex-col overflow-hidden items-center justify-center">
      ...
      <div className="mb-32 bg-white rounded-3xl border-8 py-12 px-4 lg:px-24 border-black w-5/6 mx-auto shadow-sm font-nexa justify-center items-center flex flex-col">
        ...
        <div className="flex justify-center items-center text-lg lg:text-xl space-x-4 my-4 lg:my-0">
        ...
        <img src="about/menu.png" alt="" className="w-full h-auto flex my-4 lg:my-12" />
        <img src="about/concept.png" alt="" className="w-full h-auto flex my-4 lg:my-12" />
        <img src="about/learningoutcomes.png" alt="" className="w-full h-auto flex my-4 lg:my-12" />
        <img src="about/gameflow.png" alt="" className="w-full h-auto flex my-4 lg:my-12" />
      </div>
    </div>
  );
};
